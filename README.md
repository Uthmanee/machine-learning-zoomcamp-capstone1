...
The dataset used in this project is a **synthetic dataset sourced from Kaggle (Depression Dataset)**. It was generated artificially rather than collected from real-world observations.
